...
describe('ic_ds_ icon set', () => {
  it('exports the full icon set (deepsuite + figma extracts + product glyphs outside those sets)', () => {
    ...
    // Session row menu's pin-to-top glyph, pinned by name.
    expect(iconNames).toContain('IconPinOutline16')
  })
